export const COLORS: {[name: string]: Theme} = {
  ...
  zcodes: {
    ...
    TEXT: "#eaeaea",
    LAUREL: "#ff9db3",
    SECRET_RANK_1: "#ff4d6d",
    SECRET_RANK_2: "#ff9db3",
    SECRET_RANK_3: "#7a0c2e",
    SECRET_RANK_TEXT: "#ff9db3",
    NEXT_RANK_BAR: "#ff4d6d",
    S_RANK_BASE: "#ff4d6d",
    S_RANK_SHADOW: "#7a0c2e",
    S_RANK_TEXT: "#0d1117",
    A_RANK_BASE: "#ff9db3",
    A_RANK_SHADOW: "#b04a66",
    A_RANK_TEXT: "#0d1117",
    B_RANK_BASE: "#7a0c2e",
    B_RANK_SHADOW: "#4a0718",
    B_RANK_TEXT: "#ffb3c4",
    DEFAULT_RANK_BASE: "#3a3a44",
    DEFAULT_RANK_SHADOW: "#24242c",
    DEFAULT_RANK_TEXT: "#eaeaea",
  },
  flat: {
    BACKGROUND: "#FFF",
    TITLE: "#000",
